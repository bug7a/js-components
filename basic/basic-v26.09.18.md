...
- Template folders that keep their own copy of the library (`04-template-m2/pwa-example/basic/`, `04-template-m1/todo-app/library/`) still have the old version until you copy the new files there.
